...
export function ModalEditKCPA2({ isOpen, onClose, data, onUpdate }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`${baseUrl}/master/dataMRt3A2`, formData);

      onUpdate();
      AddLog(
        `${userData.username} edit data MRt3 A2 dengan Kode Checklist ${formData.Kode_Checklist} dan No Urut ${formData.NoUrut}`
      );
